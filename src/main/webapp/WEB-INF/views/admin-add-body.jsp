            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">                  
                    	...
                    	<form:form cssClass="form-horizontal" action="admin-add-save" id="admin-add-form" modelAttribute="user" method="post">                    	                    

								<spring:bind path="userName">
									<div class="form-group row">
									  <form:label path="userName" for="userName" class="col-lg-4 col-form-label">User Name</form:label>
									  <div class="col-lg-8">
									  	  <form:input path="userName" id="userName" label="User Name" placeholder="User Name" cssClass="form-control is-invalid" />								  	  								    
								...
								<spring:bind path="firstName">
									<div class="form-group">
									  <form:label path="firstName" for="firstName" class="col-lg-4 col-form-label">First Name</form:label>
									  <div class="col-lg-8">
									  	<form:input path="firstName" id="firstName" label="First Name" placeholder="First Name" cssClass="form-control is-invalid align-middle" />
								...
								<div class="form-group">
								  <form:label path="middleName" for="middleName" class="col-lg-4 col-form-label">Mid. Name</form:label>
								  <div class="col-lg-8">
								  	<form:input path="middleName" id="middleName" label="Middle Name" placeholder="Middle Name" cssClass="form-control" />								    
								  </div>
								</div>
								
								<spring:bind path="lastName">
									<div class="form-group">
									  <form:label path="lastName" for="lastName" class="col-lg-4 col-form-label">Last Name</form:label>
									  <div class="col-lg-8">
									  	<form:input path="lastName" id="lastName" label="Last Name" placeholder="Last Name" cssClass="form-control" />								    
								...
								<div class="form-check row">
								  ...
								  <form:label path="userRoleAdmin" for="adminCheckbox" class="col-lg-4 col-form-label">
								    Admin
								  </form:label>
								</div>														
		        ...
		        $.ajax({
		            ...
		            success: function(data){
		                 ...
		                 //$.get(this.href, function(html) {
		                	    //$(html).load("admin-add-save-sucess").modal();
		                	    //$.get(this.href, function(html) {
