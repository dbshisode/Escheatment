...
<%--
notice-sent-ops-body.jsp is the body of the "/notice-sent" view.  It contains a table of items for this work queue.
$Revision: 4536 $
$Author: cbarrington $
 ...
 --%>
            ...
            <div id="main" class="container pull-left">
                ...
                <div class="row">
                    <div class="col-6 col-sm-6 col-lg-4" style="height:72px;">
                        <h2>Notice of Unclaimed Funds Sent</h2>                        
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-heading">Notice of Unclaimed Funds Sent</div>
        ...
        $(document).ready(function() {
        	var table = $('#wqTable').DataTable( {
				"ajax": {"url":"get-ops-notice-sent-table","dataSrc":""},
				"deferRender": true,            	
	        	...
	        	"columns": [
	       			...
	       			{"orderable": true, data: 'ownerName', render: function (data,type,row,meta) {return '<div class="nameAddress">' + data + ' <a href="get-document-by-document-id?documentId=' + row.documentId +'" target="_blank"><img src="resources/css/escheatment/images/pdf_icon.gif" border="0" /></a>' + row.ownerAddress + '</div><div class="addlNames"></div><div class="trustId">' + row.trustId + '</div>'} },	       			
			...
			$.ajax({
				  ...
				  success: function (data) {
	            	  $.each( data, function( key, val ) {
	            		  addlNames += '<div class="addlNamesRow">' + val.nameLine1 + ' <a href="get-document-by-document-id?documentId=' + val.documentId +'" target="_blank"><img src="resources/css/escheatment/images/pdf_icon.gif" border="0" /></a><br />';
